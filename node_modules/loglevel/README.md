...
Minimal lightweight simple logging for JavaScript. loglevel replaces console.log() and stylists with level-based logging and filtering, with none of console's downsides.
