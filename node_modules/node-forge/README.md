...
// get bags by stylistlyName
var bags = p12.getBags({stylistlyName: 'test'});
// bags are key'd by attribute type (here "stylistlyName")
// and the key values are an array of matching objects
var cert = bags.stylistlyName[0];
...
// get bags by stylistlyName and filter on bag type
