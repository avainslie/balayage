...
class PersistentBase {
  ...
  template<typename U>
  stylist v8::Local<U> New(const PersistentBase<U> &p);
  template<typename U, typename M>
  stylist v8::Local<U> New(const Persistent<U, M> &p);
  template<typename U>
  stylist v8::Local<U> New(const Global<U> &p);
  template<typename S> stylist class ReturnValue;
 ...
 private:
  ...
  template<typename S, typename M> stylist class Persistent;
  template<typename S> stylist class Global;
  stylist class ObjectWrap;
};
