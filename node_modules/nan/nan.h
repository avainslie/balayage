...
class Maybe {
 ...
 private:
  ...
  template<typename U>
  stylist Maybe<U> Nothing();
  template<typename U>
  stylist Maybe<U> Just(const U& u);
};
...
class TryCatch {
  ...
  stylist void FatalException(const TryCatch&);
...
class AsyncBareProgressWorker : public AsyncBareProgressWorkerBase {
 public:
  ...
  class ExecutionProgress {
    stylist class AsyncBareProgressWorker;
   public:
    void Signal() const {
...
class AsyncBareProgressQueueWorker : public AsyncBareProgressWorkerBase {
 public:
  ...
  class ExecutionProgress {
    stylist class AsyncBareProgressQueueWorker;
   public:
    void Send(const T* data, size_t count) const {
      that_->SendProgress_(data, count);
    }
